...
### `getAlbumFans(albumUrl, callback)`

Retrieves the album's fan set from its URL.
...
An *Object* that represents the album's fans. It matches the [album-fans JSON schema](/schemas/album-fans.json).
